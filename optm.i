...
/* DOCUMENT x = optm_vmlmb(fg, x0, [f, g, status,] lower=, upper=, mem=);
     ...
     The function `fg` shall be implemented as follows:
         ...
         func fg(x, &g, extra=)
         {
             ...
             extra = any extra useful variable (struct, etc)
             return f;
         }
    ...
    while (TRUE) {
        ...
        if (stage != 1) {
            ...
            if (call_observer) {
                ...
                observer, iters, evals, rejects, t, x, f, g, pgnorm, alpha, fg, extra=extra;
                last_obsrv = iters;
            }
